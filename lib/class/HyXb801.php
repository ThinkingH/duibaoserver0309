...
class HyXb801 extends HyXb{
	...
	public function controller_searchproductlist(){
		...
		$typesql  = "select count(*) as num from z_tuanmainlist 
					where z='".$z."' and shstatus=11 and hyflag=1 and flag=1 and zflag=1 
		...
		//商品数据列表的获取
		$shangpinsql = "select id,faflag,new_datetime,over_datetime,type,maintype,childtype,title,content,picurl,tiaozhuanurl,yuanprice,nowprice,round(nowprice/yuanprice,2) as bydiscount,yilingcon,address,
