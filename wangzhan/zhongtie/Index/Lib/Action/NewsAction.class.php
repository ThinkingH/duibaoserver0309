...
class NewsAction extends Action {
	...
	public function dazongmacrooil(){
		...
		$sql="select id,title,content,contenttime from zt_wx_news where typeid='2' or typeid='3' order by id desc limit 20";
		$list=$Model->query($sql);
	...
	public function dazongchanye(){
		...
		$sql="select id,title,content,contenttime from zt_wx_news where typeid='2' order by id desc limit 0,20";
		$list=$Model->query($sql);
	...
	public function dazongmacrocoal(){
		...
		$sql="select id,ttitle,tcontent,createtime from zt_news where ttype='meitan' limit 20";
		$list=$Model->query($sql);
	...
	public function dazongchem(){
		...
		$sql="select id,ttitle,tcontent,createtime from zt_news where ttype='huagong' limit 20";
		$list=$Model->query($sql);
	...
	public function dazongchinanews(){
		...
		$sql="select id,title,content,contenttime from zt_wx_news where typeid='3' order by id desc limit 0,20";
		$list=$Model->query($sql);
	...
	public function redian(){
		...
		$sql="select id,title,content,contenttime from zt_wx_news where typeid='3' order by id desc limit 0,6";
		$list=$Model->query($sql); 
