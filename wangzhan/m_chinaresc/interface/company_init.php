...
$url='http://wxservice.zhaomei.com/supply/detail/'.$id.'?datacategory=4';
...
$content = $t['content'];
$replace = array("查看优惠",);
$content = str_replace($replace, '优惠价格', $content); 
...
$fenge2 = explode(' <div class="tel">',$fenge1[0]);

//去除电话的上半部分
//$fenge2[0]

$fenge3 = explode('<h2>详细指标</h2>',$fenge2[1]);

$fenge31 = explode('<div class="fixed-menu">',$fenge3[1]);

//去除电话的下半部分
//$fenge3[1]

$fenge4=$fenge2[0].$fenge31[0];


//$fenge3 = explode('<p style="text-align:center">',$fenge2[0]); */
