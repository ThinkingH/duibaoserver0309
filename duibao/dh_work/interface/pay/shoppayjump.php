...
if (count ( $list_user ) <= 0) {
	...
	$ggarr ['thenotify_url'] = HY_THEBASEURL.'dh_work/interface/reppay/shop_paycallback_11.php?myorderid='.urlencode($ggarr['myorderid']).'&paymoney='.urlencode($ggarr['paymoney']);
