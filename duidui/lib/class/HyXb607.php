...
class HyXb607 extends HyXb{
	...
	public function controller_shouyechildtypelist(){
		...
		//分类数据的查询
		$typesql  = "select count(*) as num from z_quanmainlist where z='".$z."' and flag=1 and zflag=1 and childtype='".$this->quanshow."' ";
		...
		$shangpinsql  = "select id,hyflag,new_datetime,type,maintype,childtype,title,picurl,tiaozhuanurl,
							...
							where z='".$z."' and flag=1 and zflag=1 and childtype='".$this->quanshow."'
