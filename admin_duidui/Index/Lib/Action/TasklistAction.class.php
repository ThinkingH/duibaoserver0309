	...
	public function index(){
		...
		foreach($list as $keyc => $valc) {
			...
			if(substr($list[$keyc]['mainimage'],0,1)=='/'){
				...
				$list[$keyc]['mainimage'] = $arr['duibao-basic'].$list[$keyc]['mainimage'].'?imageView2/1/w/100/h/100/q/75|imageslim';
			}
			
			if(substr($list[$keyc]['liucheng_1_img'],0,1)=='/'){
				$list[$keyc]['liucheng_1_img'] = XMAINURL.$list[$keyc]['liucheng_1_img'];
			}else{
				$list[$keyc]['liucheng_1_img']=$arr['duibao-basic'].$list[$keyc]['liucheng_1_img'].'?imageView2/1/w/200/h/200/q/75|imageslim';
			}
			
			if(substr($list[$keyc]['liucheng_2_img'],0,1)=='/'){
				$list[$keyc]['liucheng_2_img'] = XMAINURL.$list[$keyc]['liucheng_2_img'];
			}else{
				$list[$keyc]['liucheng_2_img'] = $arr['duibao-basic'].$list[$keyc]['liucheng_2_img'].'?imageView2/1/w/200/h/200/q/75|imageslim';
			}
			
			if(substr($list[$keyc]['liucheng_3_img'],0,1)=='/'){
				$list[$keyc]['liucheng_3_img'] = XMAINURL.$list[$keyc]['liucheng_3_img'];
			}else{
				$list[$keyc]['liucheng_3_img'] = $arr['duibao-basic'].$list[$keyc]['liucheng_3_img'].'?imageView2/1/w/200/h/200/q/75|imageslim';
			}
			
			if(substr($list[$keyc]['liucheng_4_img'],0,1)=='/'){
				$list[$keyc]['liucheng_4_img'] = XMAINURL.$list[$keyc]['liucheng_4_img'];
			}else{
				$list[$keyc]['liucheng_4_img'] = $arr['duibao-basic'].$list[$keyc]['liucheng_4_img'].'?imageView2/1/w/200/h/200/q/75|imageslim';
			}
			
			if(substr($list[$keyc]['liucheng_5_img'],0,1)=='/'){
				$list[$keyc]['liucheng_5_img'] = XMAINURL.$list[$keyc]['liucheng_5_img'];
			}else{
				$list[$keyc]['liucheng_5_img'] =$arr['duibao-basic'].$list[$keyc]['liucheng_5_img'].'?imageView2/1/w/200/h/200/q/75|imageslim';
			}
		...
		public function uploadimg(){
			...
			if($upimg_submit==''){
				...
				if(substr($list[0]['mainimage'],0,1)=='/'){
					...
					$list[0]['mainimage'] = $arr['duibao-basic'].$list[0]['mainimage'].'?imageView2/1/w/100/h/100/q/75|imageslim';
				}
				if(substr($list[0]['liucheng_1_img'],0,1)=='/'){
					$list[0]['liucheng_1_img'] = XMAINURL.$list[0]['liucheng_1_img'];
				}else{
					$list[0]['liucheng_1_img'] = $arr['duibao-basic'].$list[0]['liucheng_1_img'].'?imageView2/1/w/100/h/100/q/75|imageslim';
				}
				
				if(substr($list[0]['liucheng_2_img'],0,1)=='/'){
					$list[0]['liucheng_2_img'] = XMAINURL.$list[0]['liucheng_2_img'];
				}else{
					$list[0]['liucheng_2_img'] = $arr['duibao-basic'].$list[0]['liucheng_2_img'].'?imageView2/1/w/100/h/100/q/75|imageslim';
				}
				if(substr($list[0]['liucheng_3_img'],0,1)=='/'){
					$list[0]['liucheng_3_img'] = XMAINURL.$list[0]['liucheng_3_img'];
				}else{
					$list[0]['liucheng_3_img'] = $arr['duibao-basic'].$list[0]['liucheng_3_img'].'?imageView2/1/w/100/h/100/q/75|imageslim';
				}
				if(substr($list[0]['liucheng_4_img'],0,1)=='/'){
					$list[0]['liucheng_4_img'] = XMAINURL.$list[0]['liucheng_4_img'];
				}else{
					$list[0]['liucheng_4_img'] = $arr['duibao-basic'].$list[0]['liucheng_4_img'].'?imageView2/1/w/100/h/100/q/75|imageslim';
				}
				if(substr($list[0]['liucheng_5_img'],0,1)=='/'){
					$list[0]['liucheng_5_img'] = XMAINURL.$list[0]['liucheng_5_img'];
				}else{
					$list[0]['liucheng_5_img'] = $arr['duibao-basic'].$list[0]['liucheng_5_img'].'?imageView2/1/w/100/h/100/q/75|imageslim';
				}
