...
class HyXb6604 extends HyXb{
	...
	public function controller_searchproductlist(){
		...
		//商品数据列表的获取
		$shangpinsql  = "select id,new_datetime,title,picurl,spicurl,quanurl,yuanprice,nowprice,quanprice,maintype,childtype,childtype,type from z_quantaobaoke 
						where $where   
