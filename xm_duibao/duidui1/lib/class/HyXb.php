	...
	*/
	...
	protected function check_duihuan_user_day(){
		...
		$userbuysql  = "select count(id) as num from shop_userbuy where order_createtime>='".$starttime."'
				and order_createtime<='".$endtime."' and userid='".$this->xb_userid."' and productid='".$this->productid."'";
	...
	protected function check_duihuan_user_month(){
		...
		$monthbuysql  = "select count(id) as monthnum from shop_userbuy where order_createtime>='".$startmonth."'
				and order_createtime<='".$endmonth."' and userid='".$this->xb_userid."' and productid='".$this->productid."' ";
	...
	protected function check_duihuan_user_year(){
		...
		$yearbuysql  = "select count(id) as yearnum from shop_userbuy where order_createtime>='".$startyear."'
				and order_createtime<='".$endyear."' and userid='".$this->xb_userid."' and productid='".$this->productid."' ";
	...
	//购物车的插入
	protected function userbuy_insert_data($orderno='',$code='',$fh_phone='',$fh_address='',$fh_fahuotime='',$fh_shouhuotime='',$address_id='',$shouhuoren='') {
	
		$insertuserbuysql = "insert into shop_userbuy(userid,siteid,typeid,name,price,score,productid,status,orderno,keystr,order_createtime,fh_phone,fh_address,fh_fahuotime,fh_shouhuotime,address_id,fh_shouhuoren) 
							values ('".$this->xb_userid."','".$this->siteid."','".$this->typeid."','".$this->goodsname."','".$this->price."','".$this->score."','".$this->productid."','3',
			 							'".$orderno."','".$code."','".$this->create_datetime."','".$fh_phone."','".$fh_address."','".$fh_fahuotime."','".$fh_shouhuotime."','".$address_id."','".$shouhuoren."')";
