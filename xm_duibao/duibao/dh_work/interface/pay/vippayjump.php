...
if (count ( $list_user ) <= 0) {
	...
	$ggarr ['thenotify_url'] = HY_THEBASEURL.'dh_work/interface/reppay/paycallback_10.php?myorderid='.urlencode($ggarr['myorderid']).'&paymoney='.urlencode($ggarr['paymoney']);
	$ggarr ['remark'] = $userid;
	$geturl = HY_THEBASEURL.'dh_work/interface/pay/paycreate_10.php?' . HyItems::hy_urlcreate ( $ggarr );
