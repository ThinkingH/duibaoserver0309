...
var firstUrl='./interface/companyinit.php';
//http://127.0.0.1:8001/supply/getgoodssupplyincompany?companyId=111&pageIndex=1
//var firstUrl='http://127.0.0.1:8001/newzhongtie/m_chinaresc/interface/companyinit.php';
var totalPage = 1;
var pageIndex = 0;
var titleCategory = 1;
/*  All = 1,
...
/* http://wxservice.zhaomei.com/supply/getgoodssupplyincompany?companyId=111&pageIndex=1 */
///载入现货资源数据
                ...
                if (data.success) {
                    ...
                    if (data.attr != undefined && data.attr.GoodsSupplyList.length > 0) {
                        for (var i = 0; i < data.attr.GoodsSupplyList.length; i++) {
                            ...
                            var html = "   <a class=\"inner-row " + pageStartFlag + " \"    href=\"./companycontent.php?id=" + data.attr.GoodsSupplyList[i].SupplyId + "&datacategory=" + titleCategory + "\">" +
                                    "      <p class=\"clearfix\">  " +
