...
$url = 'http://wxservice.zhaomei.com/supply/getgoodssupply?sort_key=&sort_type=&datacategory=2&search_key=&pageIndex='.$page;


$useragent = randuseragent();


$t = vget($url,$timeout=10000,$header=array(),$useragent);
