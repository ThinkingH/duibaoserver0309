...
$url='http://wxservice.zhaomei.com/supply/detail/'.$id.'?datacategory=0';
...
$fenge3 = explode('<div class="tel">',$fenge2[0]);

$fenge31 = explode(' <h2>详细指标</h2>',$fenge3[1]);

//去除电话的下半部分$fenge31[1]
//$fenge3[1]

$fenge4=$fenge3[0].$fenge31[1];
