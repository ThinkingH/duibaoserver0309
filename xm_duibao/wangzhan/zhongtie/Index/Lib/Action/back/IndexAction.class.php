...
class IndexAction extends Action {
	...
	public function index(){
		...
		/* $Model=new Model(); */
		//宏观
		$sql="SELECT id,title from zt_wx_news where typeid='2' order by id desc limit 4,4";
		$list=$Model->query($sql);
		
		$this->assign('list',$list);
		
		//石油
		$sql="select id,title from zt_wx_news where typeid='2' order by id desc limit 5,4";
		$list=$Model->query($sql);
		
		$this->assign('oil',$list);
		
		//新能源
		$sql="select id,title from zt_wx_news where typeid='2' order by id desc limit 9,4";
		$list=$Model->query($sql);
		
		$this->assign('nengyuan',$list);
		
		//钢铁
		$sql="select id,title from zt_wx_news where typeid='2' order by id desc limit 14,4";
		$list=$Model->query($sql);
		
		$this->assign('steel',$list);
		
		//化工
		$sql="select id,title from zt_wx_news where typeid='2' order by id desc limit 18,5";
		$list=$Model->query($sql);
		
		$this->assign('chem',$list);
		
		//公司
		$sql="select id,title from zt_wx_news where typeid='2' order by id desc limit 22,5";
		$list=$Model->query($sql);
		...
		//新闻列表
		$sql="select id,title from zt_wx_news where typeid='2' order by id desc limit 36,13";
		$list2=$Model->query($sql);
		
		$this->assign('nlist',$list2);
		
		
		$sql4="select id,title from zt_wx_news where typeid='2' order by id desc limit 45,3";
		$list4=$Model->query($sql4);
		
		$this->assign('zoilq',$list4);
		
		$sql5="select id,title from zt_wx_news where typeid='2' order by id desc limit 50,3";
