	...
	if($md5key!=$checkkey){
		...
		if($userjifen<$main_xiaohaoscore){//用户积分小于抽奖消耗的积分
			...
			if($prizelist['num']>=10){
				...
				$choujiangsql = "insert into choujiang (userid,phone,openid,currentscore,score,prize,choujiangtime) 
								values ('".$userkey."','".$phone."','".$openid."','".$userjifen."','".$f_score."','".$prize."','".$shijian."')";
