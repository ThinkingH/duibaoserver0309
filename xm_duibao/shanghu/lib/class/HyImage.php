...
class HyImage {
	 ...
	 * @return string
	 */
	public function buildImageVerify($length=4, $mode=1, $verifyName='verify', $type='png', $width=48, $height=22) {
		
		$randval = HyItems::randString($length, $mode);
		$HySession = new HySession();
		$HySession->set($verifyName, md5($randval));
