...
$paytype = 14;  //14为h5支付
$thereport_url = HY_THEBASEURL.'dh_work/interface/reppay/shop_payreport_11.php';
...
if($thenotify_url=='') {
	$thenotify_url = HY_THEBASEURL.'dh_work/interface/reppay/shop_paycallback_11.php';
}
